...
public class WordKmeans {
    private static Logger logger = LoggerFactory.getLogger(WordKmeans.class);
    ...
    public WordKmeans(HashMap<String, float[]> wordMap, int clcn, int iter) {
        try {
            ...
            logger.error("WordKmeans() error ",e);
        }
    }
    ...
    public static class Classes {
        ...
        public void updateCenter(HashMap<String, float[]> wordMap) {
            try {
                ...
                logger.error("Classes updateCenter() error! ",e);
            }
        }
        ...
        public void clean() {
            try {
                ...
                logger.error("Classes clean() error!" ,e);
            }
        }
        ...
        public List<Entry<String, Double>> getTop(int n) {
            try {
                ...
                logger.error("Classes getTop() error! ",e);
                return null;
            }
        }
